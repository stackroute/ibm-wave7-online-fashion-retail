...
//        when(manufactureService.saveManufacture(manufacturer)).thenReturn(manufacturer);
//        mockMvc.perform(post("/manufacture")
//                .contentType(MediaType.APPLICATION_JSON)
//                .content(asJsonString(manufacturer)))
//                .andExpect(status().isCreated());
//        verify(manufactureService, times(1)).saveManufacture(Mockito.any(Manufacturer.class));
//        verifyNoMoreInteractions(manufactureService);
//    }
//
//    @Test
//    public void getAllUsers() throws Exception{
//        List<Manufacturer> userslist = new ArrayList<>();
//        userslist.add(manufacturer);
