...
public class CommandLineStartUpRunner implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        DesignerOrder designerOrder1 = new DesignerOrder("1","1234",design1,List.of(Map.of("1",3.0,"2",5.0)),manufacturer1,"");
        DesignerOrder designerOrder2 = new DesignerOrder("2","4567",design2,List.of(Map.of("1",35.0,"2",5.0)),manufacturer1,"");
        try {
