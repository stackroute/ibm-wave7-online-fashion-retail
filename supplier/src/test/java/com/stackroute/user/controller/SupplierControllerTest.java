...
//        when(userService.saveSupplier(user)).thenReturn(user);
//        mockMvc.perform(post("/user")
//                .contentType(MediaType.APPLICATION_JSON)
//                .content(asJsonString(user)))
//                .andExpect(status().isCreated());
//        verify(userService, times(1)).saveSupplier(Mockito.any(Supplier.class));
...
//        userslist.add(user);
//        when(userService.getAllSuppliers()).thenReturn(userslist);
//        mockMvc.perform(post("/user")
//                .contentType(MediaType.APPLICATION_JSON)
//                .content(asJsonString(user)))
//                .andExpect(status().isCreated());
...
//    {
//        when(userService.deleteSupplier(1)).thenReturn(true);
//        mockMvc.perform(delete("/user/1")
//                .contentType(MediaType.APPLICATION_JSON))
//                .andExpect(status().isOk());
//        verify(userService, times(1)).deleteSupplier(1);
//        verifyNoMoreInteractions(userService);
//    }
//
